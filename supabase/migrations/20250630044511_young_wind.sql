/*
  ...
  1. New Data
    - Sample users with different pregnancy stages
    - Sample tracking settings for each user
    - Sample meals for the past week
    - Sample daily logs with aggregated nutrition data
  
  2. Security
    - All data is inserted with proper error handling
...
(
  ...
  '{}'::jsonb,
  '{"pushReminders": true, "healthData": true}'::jsonb,
