/*
  # Fix Food Preferences Table

  1. New Tables
    - Ensures food_preferences table exists if not already created
  2. Security
    - Enables RLS on food_preferences table
    - Adds policies for authenticated users to manage their own food preferences
  3. Performance
