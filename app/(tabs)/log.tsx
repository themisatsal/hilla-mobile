...
// Create a forwarded ref component for the camera
const ForwardedExpoCameraView = React.forwardRef<any, React.ComponentProps<typeof ExpoCameraView>>((props, ref) => {
  return <ExpoCameraView {...props} ref={ref} />;
});
...
export default function LogScreen() {
  ...
  const handleBarcodeScan = () => {
    ...
    Alert.alert(
      'Barcode Scanner',
      'Would you like to scan a food product barcode?',
      [
        {
          text: 'Cancel',
          style: 'cancel'
  ...
  const handleVoiceInput = () => {
    Alert.alert(
      'Voice Input',
      'Would you like to describe your meal using voice?',
      [
        {
          text: 'Cancel',
          style: 'cancel'
        },
        {
          ...
          onPress: () => {
            ...
            setTimeout(() => {
              Alert.alert(
                'Voice Recognized',
                'I heard: "Greek yogurt with berries and honey"',
                [
                  {
                    text: 'Cancel',
                    style: 'cancel'
